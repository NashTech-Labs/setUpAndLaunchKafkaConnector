...
# Read the topic data
docker run --rm -it --net=host landoop/fast-data-dev bash
kafka-console-consumer --topic demo-2-distributed --from-beginning --bootstrap-server 127.0.0.1:9091
...
kafka-console-consumer --topic demo-3-twitter --bootstrap-server 127.0.0.1:9091
